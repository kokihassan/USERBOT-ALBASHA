...
CATLOGO = ":(?:/{0,2})(.+?)(:same)?\>)")
CATLOGO = "https://telegra.ph/file/4b26ab88d6649347f325a.png"
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**Catuserbot"):
            buttons = [
                (
                    ...
                    Button.url("Repo", "https://github.com/kokihassan/USERBOT-ALBASHA"),
                )
            ]
            ...
            markup = event.client.build_reply_markup(buttons)
            photo = types.InputWebDocument(
                url="https://telegra.ph/file/4b26ab88d6649347f325a.png",
                size=0,
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/kokihassan/USERBOT-ALBASHA"),
                Button.url(
                    "Deploy",
                    "https://dashboard.heroku.com/new?button-url=https://github.com/kokihassan/USERBOT-ALBASHA",
                ),
            )
        ]
        markup = event.client.build_reply_markup(buttons)
        ...
        text, msg_entities = await event.client._parse_message_text(
            "𝗗𝗲𝗽𝗹𝗼𝘆 𝘆𝗼𝘂𝗿 𝗼𝘄𝗻 ALBASHA𝗨𝘀𝗲𝗿𝗯𝗼𝘁.", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="ALBASHA 𝙐𝙨𝙚𝙧𝙗𝙤𝙩",
            description="Deploy yourself",
            url="https://github.com/kokihassan/USERBOT-ALBASHA",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
