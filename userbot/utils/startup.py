...
LOGS = logging.getLogger("ALBASHA")
cmdhr = Config.COMMAND_HAND_LER


async def setup_bot():
    """
    To set up bot for ALBASHA
    """
    try:
        await catub.connect()
    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await catub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/4b26ab88d6649347f325a.png",
                caption="**Your ALBASHAUserbot has been started successfully.**",
                buttons=[(Button.url("Support", "https://t.me/cptsha8"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
